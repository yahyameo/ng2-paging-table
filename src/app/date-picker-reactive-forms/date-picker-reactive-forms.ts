...
import {IAngularMyDpOptions, IMyDateModel, AngularMyDatePickerDirective} from 'projects/ng2-paging-table/src/public_api';
...
export class DatePickerReactiveForms implements OnInit {
  ...
  toggleCalendar(): void {
  //  this.myDatePickerOptions.inline=!this.myDatePickerOptions.inline
